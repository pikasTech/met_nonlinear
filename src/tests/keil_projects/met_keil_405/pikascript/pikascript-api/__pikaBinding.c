...
#ifndef PIKA_MODULE_MET_DISABLE
void MET_ProcessMethod(PikaObj *self, Args *args){
    Arg* res = MET_Process(self);
...
void MET_ScannerMethod(PikaObj *self, Args *args){
    Arg* res = MET_Scanner(self);
    method_returnArg(args, res);
}
method_typedef(
    MET_Scanner,
...
void MET_SignalGeneratorMethod(PikaObj *self, Args *args){
    Arg* res = MET_SignalGenerator(self);
    method_returnArg(args, res);
}
method_typedef(
    MET_SignalGenerator,
...
class_def(MET){
    ...
    constructor_def(MET_SignalGenerator, 384553482),
    constructor_def(MET_Process, 602888132),
    constructor_def(MET_Scanner, 1726579247),
};
class_inhert(MET, TinyObj);

PikaObj *New_MET(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, MET);
    return self;
}
#endif

#ifndef PIKA_MODULE_MET_DISABLE
void MET_Process_disableWpMethod(PikaObj *self, Args *args){
    MET_Process_disableWp(self);
}
method_typedef(
    MET_Process_disableWp,
    "disableWp", ""
);

void MET_Process_enableWpMethod(PikaObj *self, Args *args){
    MET_Process_enableWp(self);
}
method_typedef(
    MET_Process_enableWp,
    "enableWp", ""
);

class_def(MET_Process){
    __BEFORE_MOETHOD_DEF
    method_def(MET_Process_enableWp, 782309971),
    method_def(MET_Process_disableWp, 1469121184),
};
class_inhert(MET_Process, TinyObj);

PikaObj *New_MET_Process(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, MET_Process);
    return self;
}

Arg *MET_Process(PikaObj *self){
    return obj_newObjInPackage(New_MET_Process);
}
#endif

#ifndef PIKA_MODULE_MET_DISABLE
void MET_Scanner_enableMethod(PikaObj *self, Args *args){
    MET_Scanner_enable(self);
}
method_typedef(
    MET_Scanner_enable,
    "enable", ""
...
void MET_Scanner_rebootAfterScanEnableMethod(PikaObj *self, Args *args){
    MET_Scanner_rebootAfterScanEnable(self);
}
method_typedef(
    MET_Scanner_rebootAfterScanEnable,
    "rebootAfterScanEnable", ""
);

void MET_Scanner_setContinueMethod(PikaObj *self, Args *args){
    int val = args_getInt(args, "val");
    MET_Scanner_setContinue(self, val);
}
method_typedef(
    MET_Scanner_setContinue,
    "setContinue", "val"
);

class_def(MET_Scanner){
    __BEFORE_MOETHOD_DEF
    method_def(MET_Scanner_setContinue, 1935589366),
    method_def(MET_Scanner_enable, 2071294892),
    method_def(MET_Scanner_rebootAfterScanEnable, 2122853966),
};
class_inhert(MET_Scanner, TinyObj);

PikaObj *New_MET_Scanner(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, MET_Scanner);
    return self;
}

Arg *MET_Scanner(PikaObj *self){
    return obj_newObjInPackage(New_MET_Scanner);
}
#endif

#ifndef PIKA_MODULE_MET_DISABLE
void MET_SignalGenerator_disableMethod(PikaObj *self, Args *args){
    MET_SignalGenerator_disable(self);
}
method_typedef(
    MET_SignalGenerator_disable,
    "disable", ""
);

void MET_SignalGenerator_enableMethod(PikaObj *self, Args *args){
    MET_SignalGenerator_enable(self);
}
method_typedef(
    MET_SignalGenerator_enable,
    "enable", ""
);

void MET_SignalGenerator_setAmpMethod(PikaObj *self, Args *args){
    pika_float A = args_getFloat(args, "A");
    MET_SignalGenerator_setAmp(self, A);
}
method_typedef(
    MET_SignalGenerator_setAmp,
    "setAmp", "A"
);

void MET_SignalGenerator_setFreMethod(PikaObj *self, Args *args){
    pika_float f = args_getFloat(args, "f");
    MET_SignalGenerator_setFre(self, f);
}
method_typedef(
    MET_SignalGenerator_setFre,
    "setFre", "f"
);

class_def(MET_SignalGenerator){
    __BEFORE_MOETHOD_DEF
    method_def(MET_SignalGenerator_disable, 314893497),
    method_def(MET_SignalGenerator_setAmp, 461680367),
    method_def(MET_SignalGenerator_setFre, 461685966),
    method_def(MET_SignalGenerator_enable, 2071294892),
};
class_inhert(MET_SignalGenerator, TinyObj);

PikaObj *New_MET_SignalGenerator(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, MET_SignalGenerator);
    return self;
}

Arg *MET_SignalGenerator(PikaObj *self){
    return obj_newObjInPackage(New_MET_SignalGenerator);
}
#endif
...
PikaObj *New_PikaMain(Args *args){
    ...
    obj_newObj(self, "MET", "MET", New_MET);
