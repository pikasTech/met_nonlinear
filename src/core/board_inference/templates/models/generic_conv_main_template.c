...
static void run_generated_record(const port_float input_sequence[VALIDATION_SEQ_LEN][{{INPUT_DIM_MACRO}}], port_float output_sequence[VALIDATION_SEQ_LEN])
{
    uint32_t step_index;
