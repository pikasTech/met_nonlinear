...
#### 3.2.4 SVF 电路元件参数对比 (R16)

本节对比了 SVF 电路的关键元件参数：理论计算值、设计标称值以及从实测频率响应拟合结果中反推的实际值。
...
### svf_dense_vs_experiment_comparison.png

![svf_dense_vs_experiment_comparison.png](../plots/svf_dense_vs_experiment_comparison.png)


---

*报告生成时间: 2026-01-26 11:08:57*
