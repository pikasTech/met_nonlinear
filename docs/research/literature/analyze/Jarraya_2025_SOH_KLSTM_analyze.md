...
| 引用位置 | 内容摘要 |
|---------|---------|
| 第53行[EN] | 摘要：RMSE 0.001682，精度提升35倍 |
| 第115行[EN] | SOH-KLSTM混合方法介绍 |
| 第119行[EN] | KAN增强候选单元状态 |
| 第123行[EN] | B样条增强特征空间 |
| 第127行[EN] | 自学习激活函数：KAN动态学习替代预定义函数 |
| 第139行 | 贡献1：SOH-KLSTM模型引入KAN到LSTM架构 |
| 第143行 | 贡献2：KAN增强候选单元状态计算 |
| 第147行 | 贡献3：NASA PCoE数据集验证 |
| 第203行[EN] | LSTM与KAN融合，KAN的非线性逼近能力 |
| 第215行[EN] | 电池健康估计方法论介绍 |
