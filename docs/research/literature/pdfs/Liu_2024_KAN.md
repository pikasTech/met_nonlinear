...
arXiv:2404.19756v5  [cs.LG]  9 Feb 2025
...
ciBi(x)
(2.12)
where cis are trainable (see Figure 2.2 for an illustration). In principle wb and ws are redundant
...
nb = 800, and α = 0.01. We measure both the error in the L2 norm and energy (H1) norm
...
or searched in a discrete way [91].
Activation function are parametrized as polynomials [88],
...
[6] A.N. Kolmogorov.
On the representation of continuous functions of several variables as
...
[15] Hadrien Montanelli and Haizhao Yang.
Error bounds for deep relu networks using the
...
[22] Hongyi Xu, Funshing Sin, Yufeng Zhu, and Jernej Barbiˇc. Nonlinear material design using
...
[25] Eric J Michaud, Ziming Liu, and Max Tegmark.
...
[45] Alex Davies, Petar Veliˇckovi´c, Lars Buesing, Sam Blackwell, Daniel Zheng, Nenad Tomašev,
...
quantum nonergodicity in a model with a single-particle mobility edge.
Physical review
...
[69] Michael Poluektov and Andrew Polar.
A new iterative method for construction of the
...
[97] Georg Martius and Christoph H Lampert.
