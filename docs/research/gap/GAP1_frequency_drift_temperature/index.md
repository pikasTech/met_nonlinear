...
|-----|---------|---------|---------|---------|
| 1 | Lin et al. 2020, Measurement | 温度对电化学地震传感器性能的影响及补偿方法 | https://doi.org/10.1016/j.measurement.2020.107518 | docs/research/literature/pdfs/[VIP]Lin_effect_2020.pdf |
...
| 3 | Iqbal 2024, MIT DSpace | 电化学传感器Volterra系统分析，高阶核揭示传感器非线性 | https://hdl.handle.net/1721.1/156552 | docs/research/literature/pdfs/Iqbal_2024_Volterra_Electrochemical_Sensor.pdf |
...
- **缺口描述**: 电化学传感器的频率响应受温度和非线性因素影响已有完整文献支撑
- **缺口等级**: 低

## 可引用段落

> "温度漂移是电化学地震传感器的主要误差源之一（Lin et al. 2020）。块模型的高阶Volterra核具有参数可分离特性（Xu & Wang 2008），线性动态阻抗模型在更高电压下不足（Iqbal 2024），表明温度漂移与非线特性密切相关"
