...
python cli.py ep ex_projects/inference/qemu-c-inference/rnnu16_e1k_puremae_r15
...
- `models/sequence.py` 负责 `lstm`、`rnn`、`grn`、`lstm_transformer`、`onedcnn`、`tcn`、`wavenet2`、`wavenet3`。
