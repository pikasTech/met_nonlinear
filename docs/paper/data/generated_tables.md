...
| Environment | 25 C |
| Frequency grid (saved evaluation) | 10-128 Hz, 12 sampled points |
...
| Linearity band | <= 128 Hz, 12 points (10, 13, 16, 20, 25, 32, 40, 50, 64, 80, 100, 128 Hz) |
...
Origin metrics: Freq Drift = 34.50 Hz, Sens Drift = 84.56 V s/m, In-band linearity = 2.004 %.
...
| --- | --- | --- | --- | --- | --- |
| **Baseline** | **Canonical** | **B-spline KAN; odd + positive; fixed system prior; MAE+AFMAE** | **2.34** | **9.09** | **0.511** |
...
| Wiener front | Sys/trainable | Measured init., trainable | 94.87 | 64.68 | 7.478 |
| Wiener front | Rand/trainable | Random init., trainable | 102.57 | 16.65 | 5.144 |
