...
\begin{tabular}{@{}p{0.13\textwidth}p{0.16\textwidth}p{0.41\textwidth}ccc@{}}
\hline\hline
...
\textbf{Baseline} & \textbf{Canonical} & \textbf{B-spline KAN; odd + positive; fixed system prior; MAE+AFMAE} & \textbf{2.34} & \textbf{9.09} & \textbf{0.511} \\
\hline
...
\multirow{3}{=}{Wiener front} & Random/fixed & Random init., frozen & 5.37 & 22.28 & 1.308 \\
 & Sys/trainable & Measured init., trainable & 94.87 & 64.68 & 7.478 \\
 & Rand/trainable & Random init., trainable & 102.57 & 16.65 & 5.144 \\
\hline
