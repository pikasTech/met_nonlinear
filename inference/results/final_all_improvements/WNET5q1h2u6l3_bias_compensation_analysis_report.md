...
![偏置误差与RMS误差绝对值对比](figures/overview/overview_bias_rms_absolute_comparison.png)

上图展示了偏置误差和RMS误差的绝对值对比，每层包含4个柱状图：基准偏置误差、补偿后偏置误差、基准RMS误差、补偿后RMS误差。使用线性坐标轴直观显示各误差的实际数值大小。
