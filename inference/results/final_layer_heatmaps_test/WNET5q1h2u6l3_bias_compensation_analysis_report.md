...
![偏置误差与RMS误差改进对比](figures/overview/overview_bias_rms_improvement_comparison.png)

上图对比了偏置误差和RMS误差在各层的改进效果，显示了两种误差类型的不同响应模式。

## 2. 逐层详细分析

### 2.1 第1层分析

![第1层偏置误差对比](figures/layer_analysis/layer_1_bias_comparison.png)

**偏置误差改进**: 0.0%

![第1层RMS误差对比](figures/layer_analysis/layer_1_rms_comparison.png)
...
![第2层偏置误差对比](figures/layer_analysis/layer_2_bias_comparison.png)

**偏置误差改进**: 80.0%

![第2层RMS误差对比](figures/layer_analysis/layer_2_rms_comparison.png)
...
![第3层偏置误差对比](figures/layer_analysis/layer_3_bias_comparison.png)

**偏置误差改进**: 40.1%

![第3层RMS误差对比](figures/layer_analysis/layer_3_rms_comparison.png)
...
![第4层偏置误差对比](figures/layer_analysis/layer_4_bias_comparison.png)

**偏置误差改进**: 62.3%

![第4层RMS误差对比](figures/layer_analysis/layer_4_rms_comparison.png)
...
![第5层偏置误差对比](figures/layer_analysis/layer_5_bias_comparison.png)

**偏置误差改进**: 86.8%

![第5层RMS误差对比](figures/layer_analysis/layer_5_rms_comparison.png)
